...
class MyForm(QtGui.QMainWindow):
        ...
        if queryreturn == []:
            ...
            if queryreturn == []:
                if (str(label) == '' or str(label).isspace()):
                    ...
                    self.rerenderInboxToLabels()  ### Abdulla edit ###
                    self.rerenderSentToLabels()
                    self.rerenderSentFromLabels() ### Abdulla edit ###
            else:
                self.statusBar().showMessage(_translate(
    ...
    def on_action_SpecialAddressBehaviorDialog(self):
        ...
        if self.dialog.exec_():
            ...
            self.rerenderInboxFromLabels()  ### Abdulla edit ###
    ...
    def tableWidgetYourIdentitiesItemChanged(self):
        ...
        if currentRow >= 0:
            ...
            self.rerenderSentToLabels() ### Abdulla edit ###
